/*
 * Zadatak 2:
 * Ka¡zemo da su medusobno razli¡citi prirodni brojevi a i b prijateljski ako je zbroj svih djelitelja broja a, strogo manjih od a,
 * jednak broju b, a zbroj svih djelitelja broja b, strogo manjih od b, jednak broju a.
 * Napi¡site program koji u¡citava dva prirodna broja m i n, uz pretpostavku da je m < n, i ispisuje sve parove prijateljskih
 * brojeva (a, b), takve da je m ? a < b ? n. Svaki par treba ispisati to¡cno jednom.
